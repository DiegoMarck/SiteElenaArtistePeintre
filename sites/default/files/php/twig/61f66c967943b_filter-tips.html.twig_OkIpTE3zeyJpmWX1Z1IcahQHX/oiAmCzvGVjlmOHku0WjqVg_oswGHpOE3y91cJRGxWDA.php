...
class __TwigTemplate_bf5a7910aea7d10ac9ecd273654875b296f24e305bd99207d25d741f2db209ec extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/classy/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\DrupalNewWebSite - Copie (2)\\drupal-9.2.7\\core\\themes\\classy\\templates\\content-edit\\filter-tips.html.twig");
    }
